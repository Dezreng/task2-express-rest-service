...
export class CreateEntityTables1624528476366 implements MigrationInterface {
    name = 'CreateEntityTables1624528476366'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(50) NOT NULL, "order" integer NOT NULL DEFAULT '0', "description" character varying(255) NOT NULL DEFAULT '', "userId" character varying, "boardId" character varying NOT NULL, "columnId" character varying, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
