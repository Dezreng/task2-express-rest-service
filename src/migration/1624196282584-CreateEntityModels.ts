...
export class CreateEntityModels1624196282584 implements MigrationInterface {
    name = 'CreateEntityModels1624196282584'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),
				...
				"order" integer NOT NULL, "description" character varying(200) NOT NULL,
